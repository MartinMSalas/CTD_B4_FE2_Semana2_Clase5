...
const darkMode  = confirm("Che queres activar modo oscuro");

if(darkMode){
    console.log(sitio.classList.add('dark'))
    const textoBoton = sitio.querySelector(".tema button");
    console.log(textoBoton.innerHTML);
    textoBoton.innerHTML = "Cambiar a modo Claro";
}

const textoBoton2 = sitio.querySelector(".tema button");
textoBoton2.addEventListener("click", function () {
